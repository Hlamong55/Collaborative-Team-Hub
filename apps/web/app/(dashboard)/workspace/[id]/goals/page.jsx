      ...
      <div className="bg-white/5 border border-white/10 rounded-2xl p-5 mb-8">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          ...
          <input
            ...
            className="bg-white/10 px-4 py-3 rounded-xl outline-none"
          />

          <button
            onClick={handleCreateGoal}
            className="bg-gradient-to-r from-purple-600 to-pink-600 px-6 rounded-xl font-semibold hover:scale-105 transition"
          >
            Create
          </button>
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-3 mt-4">
                  ...
                  <button
                    ...
                    className="bg-purple-600 hover:bg-purple-500 px-5 rounded-xl font-medium transition"
                  >
                    Add
                  </button>
